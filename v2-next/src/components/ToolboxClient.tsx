...
const calculators = [
    ...
    { id: "global-tax", icon: "📊", title: "종합소득세 시뮬레이터", desc: "사업소득 및 프리랜서 <strong>5월 종소세 계산</strong>", links: [{ title: "+ 누진세율 가이드", url: "/guide/global-tax" }, { title: "+ 프리랜서 환급금 역산", url: "/guide/global-tax" }] },
    ...
    { id: "subscription", icon: "🏆", title: "주택청약 가점 확인", desc: "무주택기간 달력, 부양가족 <strong>84점 만점</strong>", links: [{ title: "+ 청약 글 안내", url: "/guide/subscription" }, { title: "+ 부양가족/무주택 기준", url: "/guide/subscription" }] },
